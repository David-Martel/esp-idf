...
def main() -> None:
    ...
    parser.add_argument(
        "secure_service_tbl",
        type=str,
        help="Path to secure_service.tbl generated in build directory",
    )
    parser.add_argument(
        "secure_service_num_h",
        type=str,
        help="Path to secure_service_num.h header file",
    )
    parser.add_argument(
        "secure_service_dec_h",
        type=str,
        help="Path to secure_service_dec.h header file",
    )
