...
def do_test_help_generic(dut: Dut, registration_order: str) -> None:
    dut.expect_exact("Press ENTER to see the list of tests")
    dut.confirm_write(
        '"esp console help command - {} registration"'.format(registration_order),
        expect_str="esp>",
    )
...
def do_test_help_quit(dut: Dut) -> None:
    ...
    dut.confirm_write(
        '"esp console help command - sorted registration"', expect_str="esp>"
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "qemu", marks=[pytest.mark.esp32, pytest.mark.host_test, pytest.mark.qemu]
        ),
    ],
)
...
def test_console_help_reverse_registration(dut: Dut, test_on: str) -> None:
    dut.expect_exact("Press ENTER to see the list of tests")
    dut.confirm_write(
        '"esp console help command - reverse registration"', expect_str="esp>"
    )
...
def test_console_help_verbose_level_0(dut: Dut, test_on: str) -> None:
    ...
    dut.expect_exact("Press ENTER to see the list of tests")
    dut.confirm_write(
        '"esp console help command - set verbose level = 0"', expect_str="esp>"
    )
...
def test_console_help_verbose_level_1(dut: Dut, test_on: str) -> None:
    ...
    dut.expect_exact("Press ENTER to see the list of tests")
    dut.confirm_write(
        '"esp console help command - set verbose level = 1"', expect_str="esp>"
    )
...
def test_console_help_verbose_subcommand(dut: Dut, test_on: str) -> None:
    ...
    dut.expect_exact("Press ENTER to see the list of tests")
    dut.confirm_write(
        '"esp console help command - --verbose sub command"', expect_str="esp>"
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            "target",
            marks=[pytest.mark.esp32, pytest.mark.esp32c3, pytest.mark.generic],
        ),
        pytest.param(
            "qemu", marks=[pytest.mark.esp32, pytest.mark.host_test, pytest.mark.qemu]
        ),
