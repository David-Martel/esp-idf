...
def is_empty_and_create(path: str, action: str) -> None:
    ...
    if not os.path.exists(abspath):
        ...
        print(
            "Your target path is not a directory. Please remove the",
...
def create_project(target_path: str, name: str) -> None:
    ...
    os.rename(
        os.path.join(main_folder, "main.c"),
        os.path.join(main_folder, ".".join((name, "c"))),
    )
...
def create_component(target_path: str, name: str) -> None:
    ...
    os.rename(
        os.path.join(target_path, "main.c"),
        os.path.join(target_path, ".".join((name, "c"))),
    )
    os.rename(
        os.path.join(target_path, "include", "main.h"),
...
def action_extensions(base_actions: Dict, project_path: str) -> Dict:
    def create_new(
        ...
        **action_args: str,
        ...
        target_path = action_args.get("path") or os.path.join(
            project_path, action_args["name"]
        )
