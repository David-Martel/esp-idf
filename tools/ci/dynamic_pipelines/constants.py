...
DEFAULT_BUILD_CHILD_PIPELINE_FILEPATH = os.path.join(
    IDF_PATH, "build_child_pipeline.yml"
)
DEFAULT_TARGET_TEST_CHILD_PIPELINE_FILEPATH = os.path.join(
    IDF_PATH, "target_test_child_pipeline.yml"
)
...
KNOWN_GENERATE_TEST_CHILD_PIPELINE_WARNINGS_FILEPATH = os.path.join(
    ...
    "dynamic_pipelines",
    "templates",
    "known_generate_test_child_pipeline_warnings.yml",
)
