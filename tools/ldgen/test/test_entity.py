...
class EntityDBTest(unittest.TestCase):
    ...
    def test_get_objs(self):
        ...
        self.assertEqual(
            set(objs),
            set(["croutine.S.obj", "croutine.c.obj", "croutine.cpp.obj", "timers.o"]),
        )
    ...
    def test_get_sections(self):
        ...
        expected = set(
            [".literal.prvCheckPendingReadyList", ".literal.prvCheckDelayedList"]
        )
        ...
        expected = set(
            [".literal.prvGetNextExpireTime", ".literal.prvInsertTimerInActiveList"]
        )
        self.assertEqual(set(sections), expected)
