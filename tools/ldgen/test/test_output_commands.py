...
class InputSectionDescTest(unittest.TestCase):
    ...
    def test_lib_placement(self):
        ...
        desc = InputSectionDesc(
            Entity("libfreertos.a", Entity.ALL, Entity.ALL), SECTIONS
        )
        self.assertEqual(expected, str(desc))
    ...
    def test_obj_placement(self):
        ...
        desc = InputSectionDesc(
            Entity("libfreertos.a", "croutine", Entity.ALL), SECTIONS
        )
        self.assertEqual(expected, str(desc))
    ...
    def test_exclusions(self):
        ...
        desc = InputSectionDesc(
            CROUTINE, SECTIONS, [Entity("libfreertos.a", "croutine.c")]
        )
        self.assertEqual(expected, str(desc))
