...
class Section(object):
    ...
    def __contains__(self, item):
        ...
        if (item["section"] == self.name or item["section"] == "any") and (
            self.start_address
            <= item["address"]
            < (self.start_address + len(self.data))
        ):
            return True
        else:
            return False
    ...
    def __getitem__(self, item):
        ...
        if isinstance(item, int):
            ...
            start = (
                item.start if item.start is None else item.start - self.start_address
            )
    ...
    def parse_raw_data(cls, raw_data):
        ...
        def process_data_line(line_to_process):
            ...
            def hex_to_str(hex_data):
                ...
                return "".join(
                    [
                        chr(int(hex_data[_i : _i + 2], base=16))
