...
def get_socket_msgs(i: int) -> List[str]:
    ...
    return [
        "uart_select_example: {} bytes were written to socket: {}".format(
            len(msg), msg
        ),
        "uart_select_example: {} bytes were received through socket: {}".format(
            len(msg), msg
        ),
    ]
...
def get_uart_msgs(i: int) -> List[str]:
    ...
    return [
        ...
        "uart_select_example: {} bytes were received through UART1: {}".format(
            len(msg), msg
        ),
    ]
