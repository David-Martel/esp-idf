...
def main():  # type: () -> None
    ...
    parser.add_argument(
        "--pic_path", type=str, help="What is the path of your picture", required=True
    )
    ...
    parser.add_argument("--height", type=int, help="the picture height", default=480)

    parser.add_argument("--width", type=int, help="the picture width", default=640)
